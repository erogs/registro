...
<c:set var="ACTIVE_PAGE" scope="request"><jsp:expression>Pagina.REGISTRO_UNO</jsp:expression></c:set>
<c:set var="ACTIVE_MENU" scope="request">
    <li class="active">
...
<div class="page-header">
    <h1 style="text-align: center;">Presentaci&oacute;n <br/><small>Sistema de Registros - INEI</small></h1>
</div>
